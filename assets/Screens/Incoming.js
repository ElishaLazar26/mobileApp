...
console.log(token,'getprofiles')
  ...
  const GetResturantProfil = () => {
    if(token)
    {
      fetch(`https://delivigo-api.herokuapp.com/api/v5/restaurant/profile`, {
        method: "GET",
        headers: {
 ...
 useEffect(() => {
  ...
  console.log(isEnabled, 'toggleSwitch')
    if (isEnabled === false) {
      fetch(`https://delivigo-api.herokuapp.com/api/v5/online`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`, // SET HEADER IN TOKEN
        },
      ...
      fetch(`https://delivigo-api.herokuapp.com/api/v5/offline`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`, // SET HEADER IN TOKEN
        },
