...
//         {
//           fetch(
//             `https://delivigo-api.herokuapp.com/api/v5/restaurant/orders?status=25&PageNo=1`,
//             {
//               method: "GET",
//               headers: {
    ...
    const fetchData = async () => {
      ...
      if(myToken)
      {
        const response = await fetch(
          ...
          `https://delivigo-api.herokuapp.com/api/v5/restaurant/orders?status=25&PageNo=${currentPage}`,
          {
            headers: {
