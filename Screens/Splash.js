    ...
    return (
        <SafeAreaView>
            ...
            <View style={{backgroundColor:"#2973CC",width:'100%',height:'100%'}}>
              ...
              <Text  style={{color:'white',backgroundColor:'black',width:200,height:40,fontWeight:'800',fontSize:17,textAlign:'center',borderRadius:10,marginTop:10,paddingTop:7}}>Restaurant Manager</Text>
