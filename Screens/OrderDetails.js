import {
    ...
    ScrollView,
    TouchableOpacity,
    Alert,Pressable, TouchableHighlight
  } from "react-native";
...
<View
                ...
                >
                  ...
                  >
                    ...
                    >
                     {language === 'english' ? "Total": "Kaikki yhteensä"}x
                    </Text>
                    <Text
                      style={{
                        fontSize: 20,
        ...
        >
          <Text
         onPress={(e) => HandleTimeupdateAndReject(e ,ResorderId, sumTime)}
            style={{
              color: "white",
              backgroundColor: "#EE545E",
              width: "45%",
              borderRadius: 15,
              padding: 10,
              textAlign: "center",
          ...
          >
            {language === 'english' ? "Reject": "Hylätä"}
          </Text>
          <Text
            // onPress={() => navigation.navigate("Accept")}
            onPress={(e) => HandleTimeupdateAndAccept(e ,ResorderId, sumTime)}
            style={{
              color: "white",
              backgroundColor: "#2973CC",
              width: "45%",
          ...
          >
          {language === 'english' ? "Accept": "Hyväksyä"}
          </Text>
        </View>
      </ScrollView>
        <Footer/>
